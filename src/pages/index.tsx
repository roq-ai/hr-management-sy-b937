  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Management System: Empowering teams with centralized employee data, efficient time tracking, seamless vacation management, comprehensive payroll information, and performance evaluations for an optimized workplace."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Management System: Empowering teams with centralized employee data, efficient time tracking, seamless vacation management, comprehensive payroll information, and performance evaluations for an optimized workplace.`}
            </Text>
            <Box
