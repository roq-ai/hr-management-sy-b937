...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'booking.create': { roles: ['owner', 'hr-manager', 'employee'], key: 'booking_id', tenantPath: [], userPath: [] },
  'availability.update': { roles: ['owner', 'hr-manager'], key: 'availability_id', tenantPath: [], userPath: [] },
  'shift.delete': { roles: ['owner', 'employee'], key: 'shift_id', tenantPath: [], userPath: [] },
};
